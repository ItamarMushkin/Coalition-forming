    ...
    for idx, coalition in coalitions_df.iterrows():
        ...
        nx.draw_networkx(g,
                         node_color=['green' if p.split(' (')[0] in coalition['necessary_parties'] 
                                     else 'yellow' if p.split(' (')[0] in coalition['members'] and not coalition['necessary_are_sufficient']
                                     else 'orange' if p.split(' (')[0] in coalition['members'] and coalition['necessary_are_sufficient']
